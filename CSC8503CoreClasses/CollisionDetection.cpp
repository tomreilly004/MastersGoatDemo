...
bool CollisionDetection::SphereIntersection(const SphereVolume& volumeA, const Transform& worldTransformA, 
	...
	Vector3 delta = worldTransformB.GetPosition() - worldTransformA.GetPosition(); // difference in position i.e. distance
...
bool CollisionDetection::useSAT(const Vector3 delta, Vector3 plane, const Transform& worldTransformA, const Transform& worldTransformB, const Vector3 halfSizeA, const Vector3 halfSizeB, float& penetrationDistance, Vector3& normal, Vector3& pointA, Vector3& pointB) {
	Vector3 AFor = worldTransformA.GetOrientation() * Vector3(0, 0, 1);
	Vector3 ARight = worldTransformA.GetOrientation() * Vector3(1, 0, 0);
	Vector3 AUp = worldTransformA.GetOrientation() * Vector3(0, 1, 0);
